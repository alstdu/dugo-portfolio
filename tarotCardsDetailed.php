...
<body>
    ...
    <div class="artifact-header">
        <div class="artifact-image-title">
            <h1>Online Tarot</h1>
            <img class="tarot-header-image" src="./assets/images/onlinetarot-preview.svg">
        </div>
    ...
    <div class="glass-effect section artifact-section artifact-section-grid artifact-process">
        <p>My goal for this project was to create a modern online Tarot Card Picker with my own card designs. Most
            ...
            I wanted to showcase my interest in spirituality, as well as my ability to perform basic but effective
            JavaScript. I included a unique element where you can choose how many cards to draw instead of the default
            one card.
            <br>
            This was a project very close to my heart, as this was my very first developer project when I was first
            learning the basics of JavaScript - long before I arrived at
            BCIT. I always used a physical deck, and I’ve tried some tarot apps, but I knew I could create something
    ...
    <div class="glass-effect section artifact-section artifact-section-grid artifact-challenges">
        <p>Since I admittedly started this a bit later than anticipated, I had to reduce the scope for the sake of deadlines. 
            ...
            challenges to work through, such as working on better understanding this monstrosity. Stay Tuned for iteration two
