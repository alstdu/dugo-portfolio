...
<body>
    ...
    <div class="artifact-keywords-container">
        <div class="gradient-border">
            <div class="artifact-keywords">Figma</div>
        </div>
        <div class="gradient-border">
            <div class="artifact-keywords">UI Design</div>
        </div>
        <div class="gradient-border">
            <div class="artifact-keywords">User Testing</div>
        </div>
    </div>
    <div class="artifact-header">
        <div class="artifact-image-title">
            <h1>ILog ELD</h1>
            <img src="./assets/images/ilog-preview.svg">
        </div>
        <div class="glass-effect artifact-stats">
            <p><span class="artifact-stats-headers">Time:</span> ~25 Hours</p>
            <p><span class="artifact-stats-headers">Programs:</span> Figma - Prototyping</p>
            <p><span class="artifact-stats-headers">Skills:</span> UI Design, User Research, User Testing, Figma, Figma Prototyping, User Stories & Scenarios, Empathy Mapping</p>
        </div>
    </div>
    <h2>Process V.1</h2>
    <div class="glass-effect section artifact-section artifact-process">
        <p>I knew I wanted to do an ELD project because it is the type of software my partner and in-laws create for their business. I thought it would be a great way to challenge myself to do something outside the norm of what other apps people are creating. It also helps to have someone review my work to make sure the features and layout make sense to the end user. I hope to create a working prototype of this app next term in the app development class. There are still a few features that I don’t know how to implement in Figma that I hope to implement when I build the app next term.</p>
        <figure>
        ...
        <p>Once my user flow was completed, I was able to start my wireframes. At the beginning of this project, I was still
        ...
        <p>I then moved over to Figma to complete my prototype. I did three iterations of my prototype. After the first iteration was complete,
            I moved on to user testing. The user testing was conducted using Maze, and the results were analyzed to see areas of improvement. 
            If you'd like to check out my project report detailing the user testing and results, please head to the bottom of this page!
            After getting my test results back, I improved the prototype once more and after the course was over, my professor provided
    ...
    <div class="glass-effect section artifact-section artifact-challenges">
       <p>The main issues I had were in the testing phase. As I illustrate in my report, 
        ...
        but it’s just more convenient to test on mobile if that’s how you’re being sent the test.
         One big downside to this is that the user doesn’t know they need to scroll down to see everything, 
         and hotspots do not appear if they mis-click. In my next test, I made sure to put some more thought 
        ...
        <p>The second issue I encountered was more of an oversight, which is that I wasn't aware that my classmates
            ...
            the software to avoid the need to explain how to use it. It's reasonable to say my classmates have likely
            never even heard of an ELD prior to this. I did, however; end up sending the test to said people along with my classmates.
         </p>
    </div>
    ...
    <div class="artifact-buttons-container">
        ...
        <button class="artifact-buttons"><a href="https://www.figma.com/proto/s130zms78A6kuSolnLWPo5/Phase-4?type=design&t=IHIrghTPbOQjJCOP-1&scaling=scale-down&page-id=0%3A1&node-id=1-4&starting-point-node-id=1%3A4&mode=design" target="_blank">View Prototype</a></button>
